...
export function Brand({ small = false }: { small?: boolean }) { return <span className={`brand ${small ? "brand-small" : ""}`}><img className="brand-logo" src="/jolly-logo.svg" alt=""/><span className="brand-name"><strong>Jolly<span>®</span></strong><small>DOLCIUMI & MOLTO ALTRO</small></span></span>; }
